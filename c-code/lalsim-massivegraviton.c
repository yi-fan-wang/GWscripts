...
int main(int argc , char *argv[])
{
	...
	double cache4 = XLALSimInspiralWaveformParamsLookupNonGRMassiveGravitonLambda(nonGRparams);
	printf("The default value of the MassiveGravitonLambda is %lf.\n", cache4);

	XLALSimInspiralWaveformParamsInsertNonGRMassiveGravitonLambda(nonGRparams,1.e13);
	double cache5 = XLALSimInspiralWaveformParamsLookupNonGRMassiveGravitonLambda(nonGRparams);
	printf("The injection value of the MassiveGravitonLambda is %lf.\n", cache5);
}